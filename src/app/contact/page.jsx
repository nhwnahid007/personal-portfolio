      ...
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        >
          ...
          <input
            ...
            className="bg-transparent border-2 rounded-lg border-slate-400 outline-none"
          />
          <span>Dear Nahid,</span>
          <textarea
            rows={6}
            placeholder="Write Your Message here..."
            className="h-full bg-transparent border-2 rounded-lg border-slate-400 outline-none resize-none"
            name="user_message"
          />
          <span>Regards</span>
